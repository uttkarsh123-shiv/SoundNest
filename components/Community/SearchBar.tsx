  ...
  return (
    <div className="relative mb-6">
      ...
      <input
        ...
        className="w-full pl-10 pr-4 py-3 bg-black-1/30 border border-gray-800 rounded-xl text-white-1 placeholder-white-3 focus:outline-none focus:border-green-1/50"
      />
    </div>
  );
};
