...
const NotificationHeader = ({
    ...
    <div className="flex items-center justify-between gap-2 mb-4 sm:mb-8">
        <div className="flex items-center gap-2">
            ...
            >
                <Bell size={24} className="text-green-1 sm:hidden" />
                {unreadCount > 0 && (
                    <span className="sm:hidden absolute -top-1 -right-1 h-2 w-2 rounded-full bg-green-1"></span>
                )}
            </div>
        ...
        <div className="flex items-center gap-1 sm:gap-4">
            ...
            {unreadCount > 0 && (
                <button
                    ...
                    className={cn(
                        "hidden sm:flex items-center justify-center",
                        "text-white-2 hover:text-green-1 transition-colors",
                        "sm:w-auto sm:h-auto sm:rounded-none",
                        "sm:hover:bg-transparent"
                    )}
                >
