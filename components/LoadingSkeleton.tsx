...
const LoadingSkeleton = () => {
    return (
        ...
        bg-gradient-to-r from-transparent via-green-1/10 to-transparent" />
            </div>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative w-32 h-32">
                    {/* Outer rotating ring */}
                    <div className="absolute inset-0 rounded-full border-2 border-green-1/20 animate-[spin_3s_linear_infinite]" />

                    {/* Inner pulsing circle */}
                    <div className="absolute inset-4 rounded-full bg-gradient-to-br from-green-1/20 to-green-2/20 
          animate-pulse backdrop-blur-xl" />

                    {/* Center icon */}
                    <div className="absolute inset-0 flex items-center justify-center">
                        <svg
                            className="w-12 h-12 text-green-1/30"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
