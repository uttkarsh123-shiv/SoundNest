    ...
    return (
        <section className="my-10">
            <div className="flex items-center gap-3 mb-4">
                <div className="bg-green-1/10 p-2 rounded-lg">
                    <Award size={20} className="text-green-1" />
                </div>
            ...
            <div className="bg-white-1/5 rounded-xl p-4 border border-white-1/10">
                <div className="flex flex-col md:flex-row gap-6">
                    <div className="w-full md:w-1/3 lg:w-1/4 aspect-square relative rounded-lg overflow-hidden">
                        ...
                        <Button
                            className="absolute bottom-3 left-3 bg-green-1 hover:bg-green-1/90 rounded-full size-12 flex items-center justify-center p-0"
                            onClick={() => {
                                setAudio({
                    ...
                    <div className="flex-1">
                        ...
                        <div className="mt-6 flex gap-3">
                            <Button
                                className="bg-green-1 hover:bg-green-1/90 text-white-1"
                                onClick={() => {
                                    setAudio({
                                        title: podcast.podcastTitle || "",
                                        audioUrl: podcast.audioUrl || "",
