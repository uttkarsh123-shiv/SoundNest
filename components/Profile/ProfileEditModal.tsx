  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        ...
        >
          <Pencil size={16} className="text-green-1" />
      ...
      >
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className="bg-black-2 border-gray-800 text-white-1 focus:ring-green-1 focus:border-green-1"
              autoFocus={false}
          ...
          <div className="space-y-2 w-full">
            ...
            <Textarea
              ...
              className="bg-black-2 border-gray-800 text-white-1 focus:ring-green-1 focus:border-green-1 w-full min-h-[100px]"
              maxLength={250}
            />
                  ...
                  <div key={index} className="space-y-2">
                    <div className="flex flex-col sm:flex-row gap-2">
                      <select
                        ...
                        className="bg-black-2 border border-gray-800 rounded-md text-white-1 focus:ring-green-1 focus:border-green-1 text-sm h-10 w-full sm:w-1/3"
                      >
                      ...
                      {link.platform === "other" ? (
                        <div className="flex w-full gap-2">
                          <Input
                            ...
                            className={`bg-black-2 border-gray-800 text-white-1 focus:ring-green-1 focus:border-green-1 flex-1 ${!link.customPlatform || link.customPlatform.trim() === "" ? 'border-red-500' : ''
                              }`}
                            required
                          />
                          <Button
                        ...
                        <div className="flex w-full gap-2">
                          <Input
                            ...
                            className={`bg-black-2 border-gray-800 text-white-1 focus:ring-green-1 focus:border-green-1 flex-1 ${urlErrors[index] ? 'border-red-500' : ''}`}
                          />
                          <Button
                            type="button"
                            variant="ghost"
                    ...
                    {link.platform === "other" && (
                      <div className="flex gap-2">
                        <Input
                          ...
                          value={link.url}
                          onChange={(e) => handleSocialLinkChange(index, "url", e.target.value)}
                          className={`bg-black-2 border-gray-800 text-white-1 focus:ring-green-1 focus:border-green-1 w-full ${urlErrors[index] ? 'border-red-500' : ''}`}
                        />
                      </div>
                    )}
        ...
        <div className="flex justify-end gap-3 mt-4">
          ...
          <Button
            ...
            className="bg-green-1 hover:bg-green-1/90 text-black"
          >
            Save Changes
          </Button>
        </div>
