...
const GenerateAIContent = ({
    ...
    return (
        ...
        <div className="flex rounded-full bg-black-1 p-1 w-full max-w-[520px] mx-auto">
            <button
                type="button"
                onClick={() => setIsAiContent(true)}
                className={`flex-1 text-[13px] font-semibold py-2 rounded-full transition-all ${isAiContent ? 'bg-green-1 text-black' : 'text-white-3 hover:text-white-1'}`}
            >
            ...
            <div className="space-y-6 sm:space-y-8">
                ...
                <div className="flex flex-col gap-2 sm:gap-3">
                    ...
                    <Select onValueChange={setSelectedLanguage} defaultValue={selectedLanguage}>
                        <SelectTrigger id="language-select" className="bg-black-1/50 border-green-1/10 hover:border-green-1/30 
                        ...
                        <SelectContent className="bg-black-1/95 text-white-1 border-green-1/10 rounded-xl max-h-[40vh]">
                ...
                {isAiContent && (
                    <>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8 mt-4 sm:mt-8">
                            {/* Content Tone */}
                            <div className="flex flex-col gap-2 sm:gap-3">
                                ...
                                <Select onValueChange={setTone} defaultValue={tone}>
                                    <SelectTrigger id="tone-select" className="bg-black-1/50 border-green-1/10 hover:border-green-1/30 
                                        transition-all duration-200 h-10 sm:h-12 rounded-xl text-gray-1 px-3 sm:px-4">
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <Select onValueChange={setTargetAudience} defaultValue={targetAudience}>
                                    <SelectTrigger id="target-audience-select" className="bg-black-1/50 border-green-1/10 hover:border-green-1/30 
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <Select onValueChange={setStyle} defaultValue={style}>
                                    <SelectTrigger id="style-select" className="bg-black-1/50 border-green-1/10 hover:border-green-1/30 
                                        transition-all duration-200 h-12 rounded-xl text-gray-1 px-4">
                            ...
                            <div className="flex flex-col gap-3 sm:gap-4">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="px-3 sm:px-4 py-1 sm:py-1.5 rounded-full bg-black-1/40 text-green-1 
                                        font-medium text-xs sm:text-sm border border-green-1/20">
                                ...
                                <div className="px-2 sm:px-4 py-4 sm:py-6">
                                    ...
                                    />
                                    <div className="flex justify-between mt-2 sm:mt-4 text-xs sm:text-sm text-gray-1">
                                        <span>1 min</span>
                                        <span>5 min</span>
                                        <span>10 min</span>
                                    </div>
                            ...
                            <div className="md:col-span-2 space-y-2 sm:space-y-3">
                                ...
                                <Textarea
                                    ...
                                    className={cn(
                                        ...
                                        "focus:border-green-1/50 focus:ring-1 focus:ring-green-1/50",
                                        "p-3 sm:p-4",
                        ...
                        {/* Generate Button */}
                        <div className="flex flex-col gap-4 items-center mt-6 sm:mt-8">
                            <Button
                            ...
                            >
                                {isGeneratingContent ? (
                                    ...
                                    <>
                                        Generate Content
                                        <NotebookPen size={18} className="animate-bounce" />
                                    </>
                                )}
                            </Button>
                        </div>
