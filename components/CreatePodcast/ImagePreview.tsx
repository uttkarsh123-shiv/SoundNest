  ...
  <div className="absolute top-4 left-4 opacity-0 group-hover/image:opacity-100 
    ...
    {isAiGenerated ? (
      <div className="max-md:hidden flex items-center gap-2 px-4 py-2
        bg-gradient-to-r from-green-1/80 to-green-2/80 
        backdrop-blur-xl rounded-full border border-green-1/50 
      ...
      <div className="max-md:hidden flex items-center gap-2 px-4 py-2
        bg-gradient-to-r from-green-700/80 to-blue-500/80
        backdrop-blur-xl rounded-full border border-green-700/50
        shadow-[0_4px_20px_rgba(0,0,0,0.4)]
        hover:shadow-[0_8px_32px_rgba(0,0,0,0.5)]
        transition-all duration-300 hover:scale-105">
        <div className="w-2 h-2 rounded-full bg-white animate-pulse" />
      ...
      <div className="w-full max-w-md space-y-4">
        ...
        <div className="flex items-center justify-between px-2">
          <div className="flex items-center gap-3">
            <div className="h-8 w-1 bg-gradient-to-t from-green-1 to-green-2 rounded-full" />
            <div className="space-y-1">
              <h3 className="font-bold text-sm bg-gradient-to-r from-green-1 to-green-2 
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black-1/80 backdrop-blur-sm">
              <div className="flex flex-col items-center gap-4">
                <div className="relative">
                  <div className="w-16 h-16 rounded-full border-2 border-green-1/30">
                    <div
                      className="absolute top-0 left-0 w-16 h-16 rounded-full border-2 border-green-1 border-t-transparent 
                      animate-[spin_1.5s_linear_infinite]"
                    />
                  </div>
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-base font-medium text-green-1">{progress}%</span>
                  </div>
                </div>
                <div className="flex flex-col items-center gap-1">
                  ...
                  <span className="text-xs text-green-1/80">Please wait a moment</span>
                </div>
              </div>
            </div>
          ) : image ? (
