...
const ListPodcastCard = ({
    ...
    return (
        ...
        >
            <span className="inline-block text-center w-8 text-sm font-medium text-blue-1 group-hover:scale-110 transition-transform">
                    ...
                    <figure className="flex items-center gap-3">
                        <div className="relative overflow-hidden rounded-lg">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                                <div className="bg-blue-1/80 rounded-full p-2 transform scale-0 group-hover:scale-100 transition-transform duration-300">
                                    <Play size={16} className="fill-black text-black" />
                                </div>
                            </div>
                        </div>
                        <div className="flex flex-col gap-1">
                            <h2 className="text-16 font-semibold text-white-1 truncate w-[350px] max-sm:w-[100px] group-hover:text-blue-1 transition-colors">
                                {podcastTitle}
                            </h2>
                    ...
                    <div className="flex flex-col items-end gap-2">
                        ...
                        {(podcastType || language) && (
                            <div className="flex flex-wrap gap-1 justify-end">
                                {podcastType && (
                                    <span className="inline-block bg-blue-1/20 text-blue-1 text-xs px-2 py-0.5 rounded-full">
                        ...
                        <div className="flex items-center gap-6">
                            <figure className="flex gap-2 items-center group-hover:scale-105 transition-transform">
                                <Headphones size={20} className="text-white-2 group-hover:text-blue-1 transition-colors" />
                                <span className="text-14 font-medium text-white-1">{views}</span>
                            </figure>
                            <figure className="flex gap-2 items-center group-hover:scale-105 transition-transform">
                                <Heart size={20} className="text-white-2 group-hover:text-blue-1 transition-colors" />
                            ...
                            <figure className="flex gap-2 items-center max-sm:hidden group-hover:scale-105 transition-transform">
                                <Clock size={20} className="text-white-2 group-hover:text-blue-1 transition-colors" />
