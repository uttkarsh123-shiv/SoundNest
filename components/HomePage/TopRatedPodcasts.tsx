...
interface TopRatedPodcastsProps {
    topRatedPodcasts: PodcastProps[] | undefined;
}

const TopRatedPodcasts = ({ topRatedPodcasts }: TopRatedPodcastsProps) => {
    return (
...
export default TopRatedPodcasts;