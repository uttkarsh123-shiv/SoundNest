                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        <Link
                            ...
                            className="group bg-black-1/30 border border-gray-800 rounded-xl p-6 hover:bg-black-1/40 transition-all hover:border-green-1/50"
                        >
                            <div className="flex items-center gap-4 mb-4">
                                <div className="bg-green-1/20 p-3 rounded-lg group-hover:bg-green-1/30 transition-colors">
                                    <Users className="w-6 h-6 text-green-1" />
                                </div>
                            ...
                            <div className="flex items-center gap-2 mt-4 text-green-1 group-hover:gap-3 transition-all">
                        ...
                        >
                            <div className="flex items-center gap-4 mb-4">
                                <div className="bg-green-1/20 p-3 rounded-lg group-hover:bg-green-1/30 transition-colors">
                                    <Flag className="w-6 h-6 text-green-1" />
                                </div>
